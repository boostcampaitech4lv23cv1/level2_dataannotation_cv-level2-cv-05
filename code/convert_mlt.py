...
SRC_DATASET_DIR = '/opt/ml/input/data/icdar_17'  # FIXME
DST_DATASET_DIR = '/opt/ml/input/data/icdar_17'  # FIXME
...
def main():
    # dst_image_dir = osp.join(DST_DATASET_DIR, 'selected_images')
    dst_image_dir = None
